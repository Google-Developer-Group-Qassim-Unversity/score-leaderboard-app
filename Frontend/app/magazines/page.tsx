...
import { getAllMagazines, formatMagazineDate } from "@/lib/magazines"
import { BookOpen, Calendar, FileText, ArrowLeft, Eye, Download } from "lucide-react"
                    ...
                    <div className="aspect-[3/4] relative bg-gradient-to-br from-slate-100 to-slate-200">
                      ...
                      <div className="absolute top-4 right-4 flex flex-col gap-2 opacity-0 group-hover:opacity-100 transition-all duration-500 transform translate-x-8 group-hover:translate-x-0">
                        <Link href={`/magazines/${magazine.id}`}>
                          <Button size="sm" className="w-10 h-10 p-0 rounded-full bg-white/90 text-slate-900 hover:bg-white shadow-lg">
                      ...
                      <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-500">
                        <Link href={`/magazines/${magazine.id}`}>
                          <Button className="bg-white/95 text-slate-900 hover:bg-white shadow-xl backdrop-blur-sm font-semibold px-6">
                  ...
                  <CardContent className="pt-0 space-y-3">
                    <div className="grid grid-cols-2 gap-2">
                      ...
                      <Button 
                        variant="outline" 
                        size="sm"
                        className="w-full border-slate-300 hover:border-blue-400 hover:text-blue-600 transition-colors"
                      >
