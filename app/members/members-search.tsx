      ...
      <div className="max-w-xl mx-auto mb-8">
        ...
        <div className="relative">
          ...
          <Input
            ...
            className="pl-12 pr-4 py-3 w-full border-slate-300 rounded-lg"
          />
        ...
        {searchTerm && (
          <button
            ...
            className="absolute right-3 top-1/2 transform -translate-y-1/2 p-1.5 text-slate-400 hover:text-slate-600 rounded-full"
          >
      ...
      <Card className="bg-white rounded-lg border border-slate-200">
        <div className="p-1">
          <CardHeader className="pb-6">
            ...
            <CardDescription className="text-slate-600 mt-1">Individual member performance rankings</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            {filteredMembers.length === 0 && searchTerm && (
              <div className="text-center py-12">
                ...
                <p className="text-slate-500 mb-2">No members found matching "{searchTerm}"</p>
                <Button
                  variant="outline"
                  size="sm"
                  onClick={() => setSearchTerm("")}
            ...
            {filteredMembers.length === 0 && !searchTerm && (
              <div className="text-center py-12">
                ...
                <p className="text-slate-500 mb-2">No members available</p>
              </div>
            )}
          </CardContent>
        </div>
